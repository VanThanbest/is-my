...
State play(State s, char ps, char value) 
{
	if (ps == '1') s[0][0] = value;
	else if (ps == '2') s[0][1] = value;
	else if (ps == '3') s[0][2] = value;
	else if (ps == '4') s[1][0] = value;
	else if (ps == '5') s[1][1] = value;
	else if (ps == '6') s[1][2] = value;
	else if (ps == '7') s[2][0] = value;
	else if (ps == '8') s[2][1] = value;
	else s[2][2] = value;
	return s;
}
	...
	while (true) // if the player wants to choose O and machine is the first
	{
		...
		if (checkFinal(s)) // give game results and scores
		{
			...
			if (score == -1) // if you win
			{
				...
				{
					if (percentWin > 50) // make a comment
                    {
                        cout << "You are 'dang's cap'!" << endl;
                    }
                    else if ( percentWin == 50)
